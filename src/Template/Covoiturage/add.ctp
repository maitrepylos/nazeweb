...
echo $this->Form->input('id_evenement', ['type' => 'select' , 'label' => 'Evènement : ', 'options' => $evenements]);
echo $this->Form->input('id_personne', ['type' => 'select' , 'label' => 'Conducteur : ', 'options' => $personnes]);
